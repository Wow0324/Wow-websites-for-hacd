...
const Home2 = () => {
    ...
    useEffect(() => {
        ...
        const interval = setInterval(() => {
            const newSrc = "/pool/table_2"; // Replace with your desired new src
        ...
        <div className='bg-gradient-to-tr from-[#020038] to-[#40057d]'>
            ...
            <div className='mx-auto flex flex-row items-center p-7 gap-5 sm:pt-20 sm:gap-10'>
                <div className='flex-1 text-center text-white font-bold'>
                    ...
                    <p className='text-xl sm:text-2xl italic'>WoW_II hosted on high speed server.</p>
            ...
            <div className='flex flex-col items-center sm:py-5 px-5'>
                <div className='container mx-auto text-white text-center'>
                    ...
                    <p>Change the IP address in poolworker.config.ini file to&nbsp; 209.105.243.206:3339</p>
                    <p>Enter your reward address and CPU Core # in supervene Then Save It !</p>
                    <span>Run poolworker and Happy Mining $HAC !!!</span>
                    <p>View mining status enter 209.105.243.206:3340 in your browser or click <a href="http://209.105.243.206:3340/" className="underline underline-offset-2" target="_blank">here</a>.</p>
                    <br />
            ...
            <div className='container mx-auto flex flex-col items-center p-5'>
                <h1 className="text-center text-white font-bold text-2xl mb-5 sm:text-4xl sm:mb-10">WoW_II Live Table</h1>
                <iframe
                    ref={iframeRef}
                    id="my-iframe"
                    src="/pool/table_2"
