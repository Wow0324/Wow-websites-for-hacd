...
const Hacd = () => {
    ...
    return (
        <div className='bg-white'>
            <div className="py-7 sm:py-20 bg-[url('./images/background3.jpg')]">
                <HacdCollection />
            </div>

            <div className='py-7 sm:py-20 bg-back-main1'>
                <TopOfName/>
            </div>
            ...
            <div className='py-7 sm:py-20 bg-back-main2'>
            ...
            <div className='py-7 sm:py-10 bg-[#924dea]'>
                <div className='text-white sm:text-xl text-sm'>
                    <div className='columns-1 sm:columns-2 sm:gap-x-0 flex flex-col sm:flex-row sm:justify-center items-center'>
                        <p className='sm:text-right text-center'>If you are interested, contact wow0527</p>
